...
public class EditJobPage extends JFrame {
   ...
   private void initialize() {
      ...
      final JLabel fillerLabel1 = new JLabel();
      ...
      JButton addBendButton = new JCustomButton("Add Bend", new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            if (EditJobPage.this.job != null) {
               ...
               EditJobPage.this.scrollPanePanel.add(fillerLabel1, DisplayComponents.GenerateConstraints(0, EditJobPage.this.job.getBends().size() + 1, 0.0D, 1.0D));
      ...
      this.scrollPanePanel.add(fillerLabel1, DisplayComponents.GenerateConstraints(0, this.job.getBends().size() + 1, 0.0D, 1.0D));
